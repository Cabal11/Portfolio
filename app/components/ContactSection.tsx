		...
		<section className="py-16 px-4 border-t border-gray-800">
			<div className="max-w-2xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-6">
					...
					<p className="text-gray-300">Interesado en trabajar juntos? Tengamos una conversación</p>
					...
					<div className="flex items-center justify-center gap-2 text-gray-300">
						...
						<span>Nosara, Guanacaste, Costa Rica</span>
					</div>

					{/* Contact Buttons */}
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:cabalcetac0@gmail.com"
					...
					<div className="flex justify-center gap-6">
						<a href="https://github.com/Cabal11" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
						...
						<a href="https://www.linkedin.com/in/christopher-valerin-418b0b173/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
							<svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
